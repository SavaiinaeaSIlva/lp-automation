# update_logo_size_process.py

# --- Configuration ---
# The name of the file you want to modify.
file_to_modify = 'process.html'

# Define the exact HTML line for the header logo to find and replace.
header_logo_original = '<img alt="Silva Automation Logo" class="h-10 md:h-12 w-auto" src="assets/images/logo.png"/>'
header_logo_new      = '<img alt="Silva Automation Logo" class="h-20 md:h-24 w-auto" src="assets/images/logo.png"/>'

# Define the exact HTML line for the footer logo to find and replace.
footer_logo_original = '<img alt="Silva Automation Logo" class="h-10 w-auto mx-auto md:mx-0" src="assets/images/logo.png"/>'
footer_logo_new      = '<img alt="Silva Automation Logo" class="h-20 w-auto mx-auto md:mx-0" src="assets/images/logo.png"/>'
...
try:
    ...
    print("Please make sure this script is in the same folder as your process.html file.")
